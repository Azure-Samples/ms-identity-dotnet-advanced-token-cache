...
Function Cleanup
{
    ...
    {
	    Write-Host "Unable to remove the 'WebApi-SharedTokenCache' . Try deleting manually." -ForegroundColor White -BackgroundColor Red
    }
    ...
    {
	    Write-Host "Unable to remove the 'ProfileSPA-SharedTokenCache' . Try deleting manually." -ForegroundColor White -BackgroundColor Red
    }
