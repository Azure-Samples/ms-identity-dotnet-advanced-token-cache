...
Function ConfigureApplications
{
   ...
   $webAppAadApplication = New-MgApplication -DisplayName "WebApp-SharedTokenCache" `
                                                      -Web `
                                                      @{ `
    ...
    Update-MgApplication -ApplicationId $webAppAadApplication.Id -IdentifierUris @("https://$tenantName/WebApp-SharedTokenCache")
